// app/services/consultations/healthy-hair-consultation/page.tsx
import Image from "next/image";
import Link from "next/link";
import type { Metadata } from "next";

export const metadata: Metadata = {
  title: "Healthy Hair Consultation — Designerae Inc.",
  description:
    "Discuss your hair goals, current routine, and products. Duration: 30 minutes. Book your Healthy Hair Consultation at Designerae Inc.",
};
...
export default function HealthyHairConsultationPage() {
  return (
      ...
      <section className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="mx-auto max-w-4xl rounded-2xl border border-neutral-200 bg-white shadow-sm overflow-hidden">
          ...
          <div className="relative aspect-[21/9] w-full overflow-hidden">
            <Image
              src="/services/healthy-hair-consultation.jpg"  // Add image at /public/services/healthy-hair-consultation.jpg
              alt="Healthy hair consultation service"
              fill
          ...
          <div className="p-8 sm:p-12">
            ...
            <p className="mx-auto mt-6 max-w-3xl text-center text-lg leading-relaxed text-neutral-600">
              Where are you on this natural hair journey? Where do you want to be? Let's chat about your <strong>#hairgoals</strong>!
            </p>
            ...
            <div className="mx-auto mt-12 max-w-3xl space-y-4 border-t border-neutral-200 pt-8">
              ...
              <p className="text-base leading-relaxed text-neutral-700">
                Your hair is unique, and so is your journey. During this consultation, we'll assess your current hair health, discuss your goals, and create a personalized care plan tailored to your specific needs.
              </p>
              <p className="text-base leading-relaxed text-neutral-700">
                Come prepared to discuss the products you've been using, your current styling schedule, and styles you like. Whether you're dealing with breakage, seeking length retention, or want to embrace your natural texture, we'll provide expert guidance to help you achieve your hair goals.
              </p>
            </div>
              ...
              <div className="rounded-xl border border-neutral-200 bg-neutral-50 p-6">
                ...
                <ul className="mt-3 space-y-2 text-sm text-neutral-700">
                  <li className="flex items-start gap-2">
                    ...
                    <span>Comprehensive hair & scalp assessment</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-emerald-600"></span>
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-emerald-600"></span>
                    <span>Personalized care routine</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-emerald-600"></span>
                    <span>Goal setting & timeline</span>
                  </li>
                </ul>
              </div>
              <div className="rounded-xl border border-neutral-200 bg-neutral-50 p-6">
                <h3 className="text-base font-semibold text-neutral-900">Perfect For</h3>
                <ul className="mt-3 space-y-2 text-sm text-neutral-700">
                  <li className="flex items-start gap-2">
                    <span className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-emerald-600"></span>
                    <span>Starting your natural hair journey</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-emerald-600"></span>
                    <span>Dealing with hair concerns</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-emerald-600"></span>
                    <span>Seeking professional guidance</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-emerald-600"></span>
